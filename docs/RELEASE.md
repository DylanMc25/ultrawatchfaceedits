...
- Verify that both the current-weather and forecast tap areas open Samsung Weather on the target Galaxy Watch firmware. Test the missing/disabled app case; add another app target before advertising weather-launch support on other Wear OS brands.
