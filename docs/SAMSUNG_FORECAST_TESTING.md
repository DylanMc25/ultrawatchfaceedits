...
| Replaceability/taps | Another eligible provider replaces the entire rectangle and its tap; restore Weather under Ultra Info Board Weather | Earlier physical display/tap confirmed; Samsung selection unresolved. Version 9/10 stock native-picker round trips passed with the wider type list. Version 11 narrowed-menu tests pending |
...
| Active/ambient | Enlarged forecast and circular readings are readable; ambient retains black time/date only | Version 11 native captures and physical readability pending. Historical version 10 captures: 4.6902% small / 5.2127% large lit |
