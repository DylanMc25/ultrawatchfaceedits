...
- Final [version 10 run 35677889561](https://github.com/DylanMc25/ultrawatchfaceedits/actions/runs/35677889561), source `e9fe68d`, passes the build and both complete emulator runs. Reviewed picker screenshots show **Ultra Forecast** in full on both sizes. Ambient captures are 5.2127% large / 4.6902% small, below 15%.
