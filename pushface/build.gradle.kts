...
android {
    ...
    defaultConfig {
        ...
        minSdk = 36
        targetSdk = 36
        versionCode = providers.gradleProperty("pushVersionCode").orElse("11").get().toInt()
        versionName = providers.gradleProperty("pushVersionName").orElse("0.2.0-preview.4").get()
    }
